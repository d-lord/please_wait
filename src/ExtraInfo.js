  ...
  render() {
    if (this.props.show === true) {
      ...
      return (
        ...
        <button className="extra-info-expanded-button" onClick={this.props.onClick}>X</button>
        <h2>Credits</h2>
      ...
      return (
        ...
        <button className="extra-info-hiding-button" onClick={this.props.onClick}>More info</button>
        </div>
      );
    }
  }
